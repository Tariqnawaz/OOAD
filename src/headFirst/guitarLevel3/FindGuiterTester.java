...
public class FindGuiterTester {
	...
	public static void initializeInventory(Inventory inventory){
		...
		inventory.addGuitar("V95700", Builder.FENDER, "Stratocastor", Type.ELECTRIC, Wood.ALDER, Wood.ALDER, 1395.95 , 12);
		inventory.addGuitar("V95700", Builder.FENDER, "Stratocastor", Type.ELECTRIC, Wood.ALDER, Wood.ALDER, 1595.95 , 12);
	}
}
